...
- Blank-monitor and multi-monitor reliability hardening
...
* Thu Sep 04 2026 Wallhaven Plasma Port <wallhaven@local> - 3.4.1-1
- Fix notification flood and multi-monitor search overwrite
* Thu Sep 04 2026 Wallhaven Plasma Port <wallhaven@local> - 3.4.0-1
- Daily-driver: auth UX, cache warm/prune, trip mode, plasmoid controls
* Wed Sep 03 2026 Wallhaven Plasma Port <wallhaven@local> - 3.3.1-1
- Fix API key D-Bus PendingReply corruption (401s)

* Wed Sep 03 2026 Wallhaven Plasma Port <wallhaven@local> - 3.3.0-1
- 3.3.0 release

* Tue Sep 02 2026 Wallhaven Plasma Port <wallhaven@local> - 3.2.0-1
- 3.2.0 release
